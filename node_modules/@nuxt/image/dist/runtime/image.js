...
export function createImage(context, { providers, defaultProvider, presets, intersectOptions, responsiveSizes }) {
    ...
    function parseImage(source, modifiers, options = {}) {
        ...
        const image = provider.provider.getImage(src, preset ? preset.modifiers : modifiers, { ...provider.defaults, ...options });
        return {
            src,
            provider,
            preset,
    ...
    function image(source, modifiers, options = {}) {
    ...
    image.sizes = (src, sizes, operations = {}) => {
    ...
    image.getMeta = async (source, modifiers, options = {}) => {
...
function createObserver(intersectionOptions) {
    ...
    printObserver(() => {
        Object.values(elementCallbackMap).forEach((callback) => callback(callbackType.print));
    });
